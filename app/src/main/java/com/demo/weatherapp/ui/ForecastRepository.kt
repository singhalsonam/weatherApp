...
class ForecastRepository() {
     ...
     fun getWeatherForecast(zipCode: String) {
        RetrofitInstance.api.getWeatherData(
            ...
            override fun onResponse(call: Call<Forecast?>, response: Response<Forecast?>) {
                Log.d("ForecastRepo", "Forecast details: ${response.body()?.list} ")
                response.body()?.let {
    ...
    /**
     * Method to return city liveData
     */
    ...
    /**
     * Method to return Forecast liveData
     */
    fun observeForecastLiveData(): MutableLiveData<List<WeatherForecast>> {
